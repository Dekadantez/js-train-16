...
function filterStudentsByGrade(students, grade) {
  ...
  let filtred = students.filter((elem) => elem.grade == grade);
...
function compareArrays(arr1, arr2) {
  ...
  console.assert(json1 === json2, "Assertion failed: Масиви не однакові!");
...
function validateUserInput(userInput) {
  ...
  if (!userInput.username === true) {
    console.info("Помилка: ім'я користувача відсутнє!");
  }
  if (!userInput.password === true) {
